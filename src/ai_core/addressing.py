...
PROMPT = (
    ...
    "\n"
    "Say yes when it follows on from what you just said — a short question or "
    "reply that only makes sense as a continuation (\"and tomorrow?\", \"why?\", "
    "\"do that\", \"what about Delhi\").\n"
    "Say no when it is someone talking to another person, background media, or "
    "a stray sentence with nothing to do with your last reply. When you can't "
    "tell, say no: staying quiet is the safe mistake."
)
