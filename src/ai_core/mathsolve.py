...
PROMPT = (
    ...
    "\n"
    "Spoken English is loose about operators: \"x by y\" and \"x over y\" both "
    "mean division, \"of\" after a percentage means multiply, and \"to the "
    "power\" means **. Read for the intended sum.\n"
    "\n"
